        ...
        >
          <div className="w-full max-w-5xl rounded-[1rem] sm:rounded-[2rem] overflow-hidden shadow-[0_20px_50px_-15px_rgba(0,0,0,0.4)] lg:shadow-[0_40px_80px_-15px_rgba(0,0,0,0.5)] bg-[#0c0c0e] aspect-[16/10] relative group border border-white/5">
            ...
            <Image
              ...
              alt="Good First Guide platform interface preview"
              fill
              priority
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "Good First Guide",
            applicationCategory: "DeveloperApplication",
            operatingSystem: "Web",
            description:
              "An intelligent platform helping beginners contribute to open source through curated GitHub issues and VS Code integrations.",
            author: {
              "@type": "Person",
              name: "Rahul Chouhan",
            },
            url: "https://rahul-chouhan.vercel.app/projects/good-first-guide",
            image: "https://rahul-chouhan.vercel.app/projects/GFG-cover.png",
          }),
        }}
      />
    </section>
