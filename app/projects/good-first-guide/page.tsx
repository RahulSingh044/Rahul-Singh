      ...
      <div className="py-16 space-y-12">
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-600 font-medium leading-relaxed">
                ...
                the friction new contributors face—such as discovering suitable
                issues, setting up local environments, and breaking down complex
                workflows.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="z-10">
              ...
              <p className="text-gray-300 font-medium leading-relaxed">
                ...
                messy codebases. We solve this by compiling curated, tailor-made
                tasks to convert friction into a clean learning path.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="lg:col-span-8 space-y-4">
              ...
              <p className="text-gray-600 font-medium text-lg leading-relaxed">
                With direct extension integration and GitHub workflow pipelines,
                contributors transition seamlessly from browsing issues to
                compiling production code inside their native editor with
                minimal ambient setups.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="lg:col-span-8 space-y-4">
              ...
              <p className="text-gray-600 font-medium text-lg leading-relaxed">
                ...
                community code-reviews, atomic version branching, and continuous
        ...
        >
          ...
          <p className="text-gray-500 font-medium text-md">
            As contributors grow, the framework scales alongside them—paving the
            track for collaborative integration, analytics compilation, and AI
            assistant routines.
          </p>
        </motion.div>
      </div>
