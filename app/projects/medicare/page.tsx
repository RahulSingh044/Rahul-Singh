    ...
    <section className="w-full min-h-screen text-[#1a1a1a] px-96 select-none pb-20 font-sans">
      ...
      <div className="py-16 space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Box 1: Core Marketplace Infrastructure (Role-Based Workflows) */}
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-600 font-medium leading-relaxed">
                Designed a secure multi-tenant architecture isolating workloads
                for Admins, Doctors, and Patients. The system smoothly balances
                global staff management tools, customizable clinical diagnostics
                consultation loops, and self-service practitioner searching for
                registered patients.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="z-10">
              ...
              <p className="text-gray-300 font-medium leading-relaxed">
                ...
                configuration secures protected application endpoints, monitors
                malicious API traffic rates, and instantly sanitizes
                unauthorized system access parameters upon logout events.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="lg:col-span-8 space-y-4">
              ...
              <p className="text-gray-600 font-medium text-lg leading-relaxed">
                Decoupled complex scheduling checks and massive I/O actions from
                the main runtime execution thread using a dedicated Redis and
                Celery architecture. The cluster runs unattended background
                cron-jobs for urgent user reminders, auto-compiles monthly
                clinician performance metrics, and packages heavy, asynchronous
                multi-record CSV medical history downloads.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <p className="text-2xl font-bold tracking-tight text-[#1a1a1a] leading-normal mb-6">
            “CareFlow was engineered to modernize traditional clinical
            management systems, prioritizing distributed background workers,
            secure token isolation patterns, and decoupled application
            services.”
          </p>
