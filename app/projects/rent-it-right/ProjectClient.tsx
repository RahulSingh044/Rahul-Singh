...
const RentItRightDetail = () => {
  ...
  return (
    <section className="w-full min-h-screen text-[#1a1a1a] px-4 sm:px-6 md:px-8 pb-20 font-sans relative">
      {/* Wrapper to handle perfect centering and max-width scaling on large screens */}
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="w-full rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden shadow-[0_40px_80px_-15px_rgba(0,0,0,0.5)] bg-[#0c0c0e] aspect-[16/10] relative group border border-white/5">
            ...
            <Image
              ...
              alt="Rent It Right rental marketplace backend architecture preview"
              fill
              priority
        ...
        <div className="py-16 space-y-12">
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 font-medium leading-relaxed">
                  ...
                  architecture using Node.js, Express.js, and MongoDB. The
                  system effortlessly coordinates listing management metrics,
                  role-based workflows, and distinct user routing pipelines for
            ...
            >
              ...
              <div className="z-10">
                ...
                <p className="text-gray-300 font-normal leading-relaxed">
                  ...
                  profile management integrity, and strict verification
                  workflows across concurrent requests.
                </p>
              </div>
            </motion.div>
          </div>
            ...
            >
              ...
              <div className="lg:col-span-8 space-y-4">
                ...
                <p className="text-gray-600 font-medium text-lg leading-relaxed">
                  ...
                  time-sensitive date validations away from the main API thread
                  by building a dedicated worker routine. This micro-service
                  watches calendar boundaries continuously, automatically
                  shifting confirmed records to ongoing status and closing
                  expired active contracts asynchronously.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <p className="text-2xl font-bold tracking-tight text-[#1a1a1a] leading-normal mb-6">
              “RentItRight was engineered to transcend elementary CRUD
              marketplace systems, prioritizing database atomicity, automated
              job intervals, and structural decoupling.”
            </p>
            <p className="text-gray-500 font-medium text-md">
              By abstracting temporal tracking operations out to background
              thread pooling, the platform maintains elite API responsiveness
              while guaranteeing absolute consistency for active rental
              arrangements.
            </p>
          </motion.div>
        </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "A scalable rental marketplace infrastructure built with Node.js, Express.js, MongoDB, JWT authentication, and concurrency-safe booking validation systems.",
            ...
            image: "https://rahul-chouhan.vercel.app/projects/RIR-cover.png",

            programmingLanguage: ["TypeScript", "JavaScript"],

            runtimePlatform: ["Node.js", "Express.js", "MongoDB", "Docker"],

            applicationSubCategory: "Marketplace Infrastructure",
          }),
        }}
      />
    </section>
